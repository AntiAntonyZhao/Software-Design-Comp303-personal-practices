 ...
 */
public class Card_FlyUnique 
{
	// Flyweight store
	private static final Card_FlyUnique[][] CARDS = new Card_FlyUnique[Suit.values().length][Rank.values().length];
	...
	static
	{
		for( Suit suit : Suit.values() )
		{
			...
			{
				CARDS[suit.ordinal()][rank.ordinal()] = new Card_FlyUnique(rank, suit);
			}
		}
	}
	
	// Private constructor
	private Card_FlyUnique( Rank pRank, Suit pSuit)
	{
		aRank = pRank;
		aSuit = pSuit;
	}
	 ...
	 */
	public static Card_FlyUnique get(Rank pRank, Suit pSuit)
	{
