 ...
 */
public class SortedHand_Strategy implements Iterable<Card>, Comparable<SortedHand_Strategy>
{
	 ...
	 * @pre pMaxCards > 0;
	 */
	public SortedHand_Strategy(int pMaxCards)
	{
		assert pMaxCards > 0;
		aMaxCards = pMaxCards;
	}
	 ...
	 * @pre pOrder!=null
	 */
	public SortedHand_Strategy(int pMaxCards, Comparator<Card> pOrder)
	{
	...
	@Override
	public int compareTo(SortedHand_Strategy pHand)
	{
